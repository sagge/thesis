...
\section{Payment Terminal Acceptance Testing}
\label{section:Payment terminal acceptance testing} 
...
Test environment that can be used in acceptance testing of payment terminals has several challenges to tackle and matters related to physical and technical aspects of the payment terminals have to be considered. This section discusses the background of these challenges. Customer also had a desire for open source technologies and this section discusses the benefits obtained by using open source software and hardware in acceptance testing environment for payment terminals. Section also discusses the different approaches for acceptance testing as well as how should the test suites be defined in order to make them understandable and reusable.
